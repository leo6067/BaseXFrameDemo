...
public class HBLevelView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.e("xxxxx","mViewWidth = "+mViewWidth  +" widthMeasureSpec  "+width + "    "+dip2px(mViewWidth) + "   widthMeasureSpec  - "+ widthMode );
        setMeasuredDimension(mViewWidth, getPaddingTop() + mTextFontMetrics.bottom - mTextFontMetrics.top + mTriangleHeight + mLine2TextDividerHeight + mProgressBarHeight + mPaddingBottom+60);
    }
    ...
    private void init() {
        ...
        mLine2TextDividerHeight = 0;
        mRectCorn = mProgressBarHeight / 2 +5;
...
//        canvas.drawPath(mPath, mTextBGPaint);
        ...
        if (currProgress < 30){
            //绘制文字
            canvas.drawText(mProgressText,  (float) (currProgress - textWidth / 2) +80, mPaddingTop - mTextFontMetrics.top, mTextPaint);

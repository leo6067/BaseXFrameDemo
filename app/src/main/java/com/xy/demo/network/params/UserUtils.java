...
public class UserUtils {
    ...
    public static String MD5(String params) {
        try {
            ...
            md.update(params.getBytes(StandardCharsets.UTF_8));
    ...
    public static String getToken(Context context) {
        if (TextUtils.isEmpty(UserToken) && context != null) {
            UserToken = SharedUtils.getUserString(context, "UserStringToken", "");
        }
        return UserToken;
    }
    ...
    public static void putToken(Context context, String UserStringToken) {
        ...
        SharedUtils.putUserString(context, "UserStringToken", UserStringToken);
    }

    public static String getUID(Context context) {
        if (TextUtils.isEmpty(UserUID) && context != null) {
            UserUID = SharedUtils.getUserString(context, "UserStringUid", "");
        }
        return UserUID;
    }
    ...
    public static String putUID(Context context, String UserStringUserUID) {
        ...
        SharedUtils.putUserString(context, "UserStringUid", UserStringUserUID);
        return UserUID;
    }
    ...
    public static String getChannelName(Context activity) {
        if (channelName == null) {
            channelName = SharedUtils.getUserString(activity, "UserChannelName", "");
            if (TextUtils.isEmpty(channelName)) {
                ...
                SharedUtils.putUserString(activity, "UserChannelName", channelName);
            }
        }
        return channelName;
    }
